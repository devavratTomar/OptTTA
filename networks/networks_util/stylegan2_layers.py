...
from networks.networks_util.stylegan2_op import FusedLeakyReLU, fused_leaky_relu, upfirdn2d
...
class ToRGB(nn.Module):
    def __init__(self, in_channel, style_dim, upsample=True, blur_kernel=[1, 3, 3, 1], out_channel=1):
        super().__init__()
...
class Discriminator(nn.Module):
    def __init__(self, size, channel_multiplier=2, blur_kernel=[1, 3, 3, 1], nchannels=1):
        super().__init__()
        ...
        convs = [('0', ConvLayer(nchannels, channels[size], 1))]
